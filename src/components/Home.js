        ...
        <View
          ...
          <View
            style={{
             ...
             <Image
                source={require('../database/images/right-arrow.png')}
        ...
        <View
          ...
          <View
            ...
            <View
              ...
              <Image source={require('../database/images/plus.png')}
            ...
            <View
              ...
              <Image source={require('../database/images/star.png')}
        ...
        <View
          ...
          <View
            ...
            <TouchableOpacity
              ...
              <Image
                source={require('../database/images/Photos.jpg')}
                style={{
                  width: '100%',
                  height: '100%',
                  resizeMode: 'contain',
            ...
            <TouchableOpacity>
            <Image source={require("../database/images/menu.png")}
          ...
          <View
            ...
            <Image source={require("../database/images/loupe.png")}
                   style={{height:20,width:20}} />
